...
Travis's code from code review. VERY HELPFUL and fulfilled the whiteboard requirements since it only took in an array.  This is all from Travis's code.
 */
    public static int[] mergeSort(int[] unsorted) {
        ...
        result = stitch(leftSide, rightSide);
        return result;
    }
